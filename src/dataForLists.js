...
export const CAR_MANUFACTURERS_ARRAY = [
  "Acura",
  "Abarth",
  "Alfa Romeo",
  "Aston Martin",
...
export const ALL_CAR_MODELS_ARRAY = [{"brand": "Seat", "models": ["Alhambra", "Altea", "Altea XL", "Arosa", "Cordoba", "Cordoba Vario", "Exeo", "Ibiza", "Ibiza ST", "Exeo ST", "Leon", "Leon ST", "Inca", "Mii", "Toledo"]},
...
export const ALL_CAR_MODELS_ARRAY_2 = [
  {
    "value": "ACURA",
    "title": "Acura",
    "models": [

  ...
  return (
    <header>
      ...
      <nav id="mobile_navigation">
        <ul>
          <li><a href="http://localhost:8080/" className="mobile_nav_default_link">О нас</a></li>
          <li><a href="http://localhost:8080/home" className="mobile_nav_default_link">Условия</a></li>
          <li><a href="http://localhost:8080/faq" className="mobile_nav_default_link">Частые вопросы</a></li>

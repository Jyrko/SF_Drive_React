...
export default function Step1(props) {
  ...
  return (
    <>
      <form id="step1">
        <h3 className="car_info">Vehicle Information</h3>
        <div className="form_wrapper">
          <div className="form_wrapper_container">
            ...
            <SelectInput key="car_color" customId="car_color" listData={["White"]} onChange={(e) => onChangePattern(e, setColor, COLOR_REGEX, setIsValidColor)} />
          </div>
        </div>
        ...
        <div className="form_wrapper">
          <div className="form_wrapper_container">
            ...
            <SelectInput key="engine_type" customId="engine_type" listData={["Gasoline"]} onChange={(e) => onChangePattern(e, setEngineType, ENGINE_TYPE_REGEX, setIsValidEngineType)} />
            ...
            <SelectInput key="transmission" customId="transmission" listData={["Automatic"]} onChange={(e) => onChangePattern(e, setTransmisson, COLOR_REGEX, setIsValidTransmisson)} />

            <label className="form_wrapper_container_label" htmlFor="wheel_drive">Drive</label>
            <SelectInput key="wheel_drive" customId="wheel_drive" listData={["Auto"]} onChange={(e) => onChangePattern(e, setWheelDrive, WHEEL_DRIVE_REGEX, setIsValidWheelDrive)}/>

            <label className="form_wrapper_container_label" htmlFor="vehicle_type">Body Type</label>
            <SelectInput key="vehicle_type" customId="vehicle_type" listData={["Auto"]} onChange={(e) => onChangePattern(e, setVehicleType, VEHICLE_TYPE_REGEX, setIsValidVehicleType)} />
          </div>
        </div>
